...
function cumpleHoy() {
    const URL = 'http://192.168.56.102/api/resource/Employee?fields=["employee_name","date_of_birth"]';   //Cambiar API REST
...
function cumpleMes() {
    const URL2 = 'http://192.168.56.102/api/resource/Employee?fields=["employee_name","date_of_birth"]'; //Cambiar API REST
